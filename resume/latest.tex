...
\begin{minipage}{.26\linewidth}
	\begin{flushright}
		\fbox{\includegraphics[scale=0.12]{pic}}
	\end{flushright}
\end{minipage}
\begin{description}
	\item[Language:]
...
\begin{itemize}
	...
	\item
		\ressubheading{StarOfService}{Remote}{Backend Developer}{Sep 2014 - Jun 2015}
	...
	\item
		\ressubheading{Web Production, outsource}{Chernigiv}{Backend Developer}{Apr 2012 - Jul 2012}
