...
\begin{minipage}{.26\linewidth}
	\begin{flushright}
		\fbox{\includegraphics[scale=0.25]{pic2}}
	\end{flushright}
\end{minipage}
\begin{description}
	\item[Applications:]
...
\begin{itemize}
	\item
		...
		Working as a Sr. Unity engineer on PC \& VR projects. Mostly dealing with architecture, rendering and performance.
		\begin{itemize}
				\resitem{Tech leading a team of coders - code organization / reviews / architecture}
				\resitem{Third-party plugin research, considerations and integration}
